...
-  `clean_notebooks.py` — Removes transient widget metadata and other noisy keys from notebooks to avoid large diffs and noisy history; run this before committing `.ipynb` files.
